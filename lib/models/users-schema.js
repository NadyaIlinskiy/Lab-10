...
// User schema that mongoose will use to validate against
 ...
 * Will use bcyrpt to create a hashed password
 ...
 * Will find a user by username and check if the password is correct using the 
 * comparePassword function
 * Return true if the username and password match what is saved in the db
 * @param  {object} creds
 * @returns {boolean}
 */
